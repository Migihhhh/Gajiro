...
if (isset($_POST['delete'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM dbo.cart WHERE id = ?");
    $stmt->execute([$itemId]);
...
$stmt = $conn->prepare("SELECT * FROM dbo.cart");
$stmt->execute();
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse show" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a class="nav-link custom-link text-light" href="new_release.html">New Release</a></li>
                ...
                <div class="d-flex">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item"><a class="nav-link custom-link text-light" href="wishlist.html">Wishlish</a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle custom-link text-light" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Mabuhay, User! 
                            </a>
            ...
            <div class="col-md-12">
                <div class="card p-3 d-flex flex-row align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="mb-1"><?php echo htmlentities($item['game_name']); ?></h5>
